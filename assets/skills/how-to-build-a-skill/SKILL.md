...
Bei **jeder inhaltlichen Änderung** an einem Skill die Version anpassen:

| Änderung                                                    | Version                     |
| ----------------------------------------------------------- | --------------------------- |
| Neuer Subcommand, neues Feature, neue Abhängigkeit          | **major** +1 → `2.0`, `3.0` |
| Bugfix, Textkorrektur, Beispiel ergänzt, Frontmatter-Update | **minor** +1 → `1.1`, `1.2` |

Learn how to write effective Skills that an AI agent can discover and use successfully.

---

Good Skills are concise, well-structured, and tested with real usage. This guide provides practical authoring decisions to help you write Skills that an AI agent can discover and use effectively.
...
The [context window](/docs/en/build-with-claude/context-windows) is a public good. Your Skill shares the context window with everything else the AI agent needs to know, including:
...
- **AI assistant (e.g. claude.ai):** Can install packages from npm and PyPI and pull from GitHub repositories
- **AI API:** Has no network access and no runtime package installation
...
Diese Dokumentation wurde von https://platform.claude.com/docs/en/agents-and-tools/agent-skills/best-practices abgeleitet
